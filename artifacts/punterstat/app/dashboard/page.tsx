    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard
          ...
          value={calibration.sampleSize > 0 ? Math.round(calibration.accuracy * 100) : "—"}
          suffix={calibration.sampleSize > 0 ? "%" : undefined}
          icon={Target}
          iconColor="text-rose-600"
          iconBg="bg-rose-50"
          note={
            calibration.sampleSize > 0
              ? `From ${calibration.sampleSize} resolved prediction${calibration.sampleSize !== 1 ? "s" : ""}`
              : "Track a prediction to start scoring"
          }
        />
      </div>
