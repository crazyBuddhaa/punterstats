          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <textarea
                ...
                rows={6}
                className="w-full rounded-xl border border-border bg-slate-50 px-3 py-2 font-mono text-xs text-[#0f172a] placeholder:text-[#1e293b]/30 focus:outline-none focus:ring-2 focus:ring-violet-500/30 resize-y"
