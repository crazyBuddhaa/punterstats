...
import { markLessonComplete } from "@/lib/betting-academy/actions";
...
export function CompleteButton({ lessonId, topicSlug, moduleSlug, initialCompleted }: Props) {
  ...
  function handleComplete() {
    ...
    startTransition(async () => {
      const result = await markLessonComplete(lessonId, topicSlug, moduleSlug);
